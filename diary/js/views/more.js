...
export function render() {
  ...
  document.getElementById('view').innerHTML = `
    ...
    <div class="card">
      <p class="faint">Tagebuch · Version 1.0</p>
      <p class="faint" style="margin-top:6px">Alle Daten bleiben ausschließlich lokal auf diesem Gerät gespeichert und sind aktuell nicht verschlüsselt.</p>
    </div>
  `;
  ...
  document.getElementById('reset-all').addEventListener('click', async () => {
    const ok = await confirmDialog('Wirklich alle Daten löschen?', 'Alle Tagebuch-Einträge werden unwiderruflich gelöscht.', 'Alles löschen', true);
    if (!ok) return;
